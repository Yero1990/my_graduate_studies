void make_plot(int set, int pm, int thnq)
{
  ...
  //string thnq_set = Form("thnq%d_Q2_4to5GeV", thnq);
  ...
  simc_ztar_diff_fsi->SetLineWidth(2);                                                                                                                                   
  ...
  //Set SIMC Histo Aesthetics
  simc_eytar_fsi->SetLineWidth(2);
  simc_eytar_fsi->SetLineColor(kRed);
  
  simc_exptar_fsi->SetLineWidth(2);
  simc_exptar_fsi->SetLineColor(kRed);
    
  simc_eyptar_fsi->SetLineWidth(2);
  simc_eyptar_fsi->SetLineColor(kRed);

  simc_edelta_fsi->SetLineWidth(2);
  simc_edelta_fsi->SetLineColor(kRed);

  simc_hytar_fsi->SetLineWidth(2);
  simc_hytar_fsi->SetLineColor(kRed);

  simc_hxptar_fsi->SetLineWidth(2);
  simc_hxptar_fsi->SetLineColor(kRed);

  simc_hyptar_fsi->SetLineWidth(2);
  simc_hyptar_fsi->SetLineColor(kRed);

  simc_hdelta_fsi->SetLineWidth(2);
  ...
  //Set SIMC Histo Aesthetics
  simc_Q2_fsi->SetLineWidth(2);
  simc_Q2_fsi->SetLineColor(kRed);

  simc_thnq_fsi->SetLineWidth(2);
  simc_thnq_fsi->SetLineColor(kRed);
  
  simc_emiss_fsi->SetLineWidth(2);
  simc_emiss_fsi->SetLineColor(kRed);

  simc_Pm_fsi->SetLineWidth(2);
  ...
  data_ztar_diff->SetFillColorAlpha(kBlue, 0.35);  
  data_ztar_diff->SetFillStyle(3004); 
  ...
  simc_eytar_fsi->Draw("samesE0");
  
  c1->cd(2);
  data_exptar->Draw("sameshistE0");
  simc_exptar_fsi->Draw("sames");
  
  c1->cd(3);
  data_eyptar->Draw("sameshistE0");
  simc_eyptar_fsi->Draw("sames");
  
  c1->cd(4);
  data_edelta->Draw("sameshistE0");
  simc_edelta_fsi->Draw("sames");
  ...
  simc_hytar_fsi->Draw("sames");
  
  c2->cd(2);
  data_hxptar->Draw("sameshistE0");
  simc_hxptar_fsi->Draw("sames");
  
  c2->cd(3);
  data_hyptar->Draw("sameshistE0");
  simc_hyptar_fsi->Draw("sames");
  
  c2->cd(4);
  data_hdelta->Draw("sameshistE0");
  simc_hdelta_fsi->Draw("sames");  
  ...
  simc_emiss_fsi->Draw("sames");  

  c3->cd(2);
  data_ztar_diff->Draw("sameshistE0");
  simc_ztar_diff_fsi->Draw("sames");  

  c3->cd(3);
  data_Q2->Draw("sameshistE0");
  simc_Q2_fsi->Draw("sames");  

  c3->cd(4);
  data_thnq->Draw("sameshistE0");
  simc_thnq_fsi->Draw("sames");  
