...
\begin{figure}[!h]
\includegraphics[scale=0.25]{plots/Em_and_Q2_CUT_80MeV_35deg.png}
\caption{Event selection cuts on missing energy (left) and 4-momentum transfer (right).}
\label{fig:Em_Q2_cuts}
\includegraphics[scale=0.25]{plots/deltaAcc_and_ZtarCUT_80MeV_35deg.png}
...
energy cut around the deuteron binding energy ($\sim$2.2 MeV) using the missing energy formula described in the Letter, where the
recoiling system is assumed to be a neutron. The peak is not exactly at the deuteron binding energy because energy loss corrections have not
been applied to the data nor SIMC. Figure \ref{fig:Em_Q2_cuts} (right) shows a kinematical cut made on the 4-momentum transfer at $Q^{2} = 4.5\pm0.5$ (GeV/c)$^{2}$
...
\begin{figure}
\includegraphics[scale=0.25]{plots/coin_and_eCal_CUT_80MeV_35deg.png}
...
\noindent Figures \ref{fig:d2_kin_35deg} and \ref{fig:d2_kin_45deg} show the fundamental kinematic variable distributions for each of the central missing momentum settings at $\theta_{nq}=35^{\circ}$ and $45^{\circ}$.
...
\begin{figure}[!h]
\includegraphics[scale=0.3]{plots/d2_kin_thnq35.png}
...
\includegraphics[scale=0.3]{plots/d2_kin_thnq45.png}
...
which is negligible.
\begin{figure}[!h]
\includegraphics[scale=0.3]{plots/tgt_bkg_d2_pm580_allthnq.png}
...
\begin{figure}[!h]
\includegraphics[scale=0.30]{plots/RC_factor.png}
...
\begin{figure}[!h]
\includegraphics[scale=0.30]{plots/BC_factor.png}
...
\clearpage
\begin{figure}[!ht]
\includegraphics[scale=0.3]{plots/Em_syst.png}
...
\begin{figure}[!h]
\includegraphics[scale=0.3]{plots/rad_sys.png}
...
\label{fig:rad_sys}
\includegraphics[scale=0.3]{plots/bc_sys.png}
\caption{Same as Fig. \ref{fig:rad_sys} but for bin-centering corrections.}
\label{fig:bc_sys}
\end{figure}
\clearpage
Figures \ref{fig:rad_sys} and \ref{fig:bc_sys} show the Barlow ratio for radiative and bin-centering systematics is mostly within 2 standard deviations which show that
