\documentclass[aps,prl,twocolumn,showpacs,superscriptaddress,groupedaddress,nofootbib]{revtex4-2}  % for review and submission
\pdfoutput=1 
...
over the kinematic bin. The systematic uncertainties associated with the radiative and bin-centering corrections were investigated using the Laget PWIA and FSI models but negligible effects on the cross sections were found (see Supplemental Material). The experimental and theoretical reduced cross sections were extracted and are defined as follows:
%\begin{equation}
