...
carried out at Jefferson Lab (JLab) \cite{PhysRevLett.113.022501,PhysRevLett.122.172502,PhysRevLett.124.212501} and Brookhaven National Lab (BNL) \cite{PhysRevLett.97.162504}. In these experiments missing momenta up to $\sim1$ GeV/c have been probed and missing momentum distributions
...
is a recoil factor \ref{cyero_phdthesis} obtained by integrating over the binding energy of the bound state in the 6-fold differential cross section and $\sigma_{\mathrm{cc1}}$ is the
