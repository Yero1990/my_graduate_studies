\documentclass[aps,prl,twocolumn,showpacs,superscriptaddress,groupedaddress,nofootinbib]{revtex4-2}  % for review and submission
\pdfoutput=1
...
carried out at Jefferson Lab (JLab) and Berkeley National Lab (BNL). In these experiments nucleon momenta up to $p_{\mathrm{r}}\sim1$ GeV/c have been probed and recoil momentum distributions
...
Recoil momenta up to $p_{\mathrm{r}}\sim1$ GeV/c have also been probed in a $^{3}\mathrm{He}(e,e'p)$ experiment \cite{PhysRevLett.94.082305,PhysRevLett.94.192302} but at a relatively low momentum transfer of 1.5 (GeV/c)$^{2}$ and at a kinematic region
...
\caption{(Color online). The ratio $R(p_{\mathrm{r}}$) is shown in (a)-(c) for $\theta_{nq}=35^{\circ}, 45^{\circ}$ and $75^{\circ}$, respectively, each with a bin width of $\pm 5^{\circ}$.
  ...
  Insets: A blowup of the corresponding subfigure in the range $p_{\mathrm{r}}=0 - 0.7$ GeV/c.}
\label{fig:fig2}
\end{figure}
