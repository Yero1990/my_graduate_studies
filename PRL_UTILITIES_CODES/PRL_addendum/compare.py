...
'''
* combine matching thnq bins from different files, i.e. pm80_set1, pm_580_set1, pm_580_set2, . . . .
* each of these has a full range of (thnq, pr) bins, howver, we want to combined all the same thnq of different files onto a single file
