...
for i, ithnq in enumerate(thnq_arr):
    ...
    #B.plot_exp(pm[thnq==ithnq], RC_fact_pwia_580s2[thnq==ithnq], RC_fact_pwia_580s2_err[thnq==ithnq], marker='^', color='g', logy=False, label='PWIA')
    B.plot_exp(pm[thnq==ithnq], RC_fact_pwia_750s1[thnq==ithnq], RC_fact_pwia_750s1_err[thnq==ithnq], marker='v', color='r', logy=False, label='PWIA')
    ...
    B.plot_exp(pm[thnq==ithnq], RC_fact_fsi_80[thnq==ithnq],  RC_fact_fsi_80_err[thnq==ithnq], marker='o', markerfacecolor='w', color='k', label='FSI | 80 MeV/c')
    B.plot_exp(pm[thnq==ithnq], RC_fact_fsi_580s1[thnq==ithnq],  RC_fact_fsi_580s1_err[thnq==ithnq], marker='s',  markerfacecolor='w',color='b', label='FSI | 580 MeV/c')
    #B.plot_exp(pm[thnq==ithnq], RC_fact_fsi_580s2[thnq==ithnq],  RC_fact_fsi_580s2_err[thnq==ithnq], marker='^',  markerfacecolor='w',color='g', label='FSI 580 (set2)')
    B.plot_exp(pm[thnq==ithnq], RC_fact_fsi_750s1[thnq==ithnq],  RC_fact_fsi_750s1_err[thnq==ithnq], marker='v',  markerfacecolor='w',color='r', label='FSI | 750 MeV/c')
    ...
    #B.plot_exp(pm[thnq==ithnq], BC_fact_pwia_580s2[thnq==ithnq], BC_fact_pwia_580s2_err[thnq==ithnq], marker='^', color='g', logy=False, label='PWIA')
    B.plot_exp(pm[thnq==ithnq], BC_fact_pwia_750s1[thnq==ithnq], BC_fact_pwia_750s1_err[thnq==ithnq], marker='v', color='r', logy=False, label='PWIA')
    ...
    B.plot_exp(pm[thnq==ithnq], BC_fact_fsi_80[thnq==ithnq],  BC_fact_fsi_80_err[thnq==ithnq], marker='o', markerfacecolor='w', color='k', label='FSI | 80 MeV/c')
    B.plot_exp(pm[thnq==ithnq], BC_fact_fsi_580s1[thnq==ithnq],  BC_fact_fsi_580s1_err[thnq==ithnq], marker='s',  markerfacecolor='w',color='b', label='FSI | 580 MeV/c')
    #B.plot_exp(pm[thnq==ithnq], BC_fact_fsi_580s2[thnq==ithnq],  BC_fact_fsi_580s2_err[thnq==ithnq], marker='^',  markerfacecolor='w',color='g', label='FSI, 580 (set2)')
    B.plot_exp(pm[thnq==ithnq], BC_fact_fsi_750s1[thnq==ithnq],  BC_fact_fsi_750s1_err[thnq==ithnq], marker='v',  markerfacecolor='w',color='r', label='FSI | 750 MeV/c')
