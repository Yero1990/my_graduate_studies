 ...
 */
 ...
 hist_name = "H_Pm", hist_title = "Missing Momentum", hist_xlabel = "#it{p}_{r} [GeV/c]";
 ...
 combine_sets(hist_80, hist_580_set1, hist_580_set2, hist_750_set1, hist_750_set2, hist_750_set3, hist_xlabel, "arb. units", hist_title, 500.);
