...
void add_hist()
{
  ...
  */
  //Deep 750 MeV,  Em_cut (-0.1, -0.04)  -- draw background
  root_dir_1 = "../../root_files/bkg_study_deep_750set1_Em_cut1/deep_data_histos_pm750_set1_combined.root";
  root_dir_2 = "../../root_files/bkg_study_deep_750set2_Em_cut1/deep_data_histos_pm750_set2_combined.root";
  root_dir_10 = "../../root_files/bkg_study_deep_750set3_Em_cut1/deep_data_histos_pm750_set3_combined.root";

  
  //Deep 750 MeV em_cut (-0.02, 0.04)  -- draw data+background
  root_dir_3 = "../../root_files/bkg_study_deep_750set1_Em_cut2/deep_data_histos_pm750_set1_combined.root";
  root_dir_4 = "../../root_files/bkg_study_deep_750set2_Em_cut2/deep_data_histos_pm750_set2_combined.root";
  root_dir_20 = "../../root_files/bkg_study_deep_750set3_Em_cut2/deep_data_histos_pm750_set3_combined.root";
  ...
  */
  TFile *data_file_750_set1_bkg = new TFile(root_dir_1.c_str());
  TFile *data_file_750_set2_bkg = new TFile(root_dir_2.c_str());
  TFile *data_file_750_set3_bkg = new TFile(root_dir_10.c_str());

  
  TFile *data_file_750_set1 = new TFile(root_dir_3.c_str());
  TFile *data_file_750_set2 = new TFile(root_dir_4.c_str());
  TFile *data_file_750_set3 = new TFile(root_dir_20.c_str());
  
  TH1F *data_Em_750_set1 = 0;
  TH1F *data_Em_750_set2 = 0;
  TH1F *data_Em_750_set3 = 0;

  TH1F *data_eztar_750_set1_bkg = 0;
  TH1F *data_eztar_750_set2_bkg = 0;
  TH1F *data_eztar_750_set3_bkg = 0;

  TH1F *data_eztar_750_set1 = 0;
  TH1F *data_eztar_750_set2 = 0;
  TH1F *data_eztar_750_set3 = 0;
  ...
  data_file_750_set1_bkg->cd();
  data_file_750_set1_bkg->GetObject("H_Em_nuc_sys", data_Em_750_set1);
  data_file_750_set1_bkg->GetObject("H_ez_tar", data_eztar_750_set1_bkg); 
  ...
  data_file_750_set2_bkg->cd();
  data_file_750_set2_bkg->GetObject("H_Em_nuc_sys", data_Em_750_set2);
  data_file_750_set2_bkg->GetObject("H_ez_tar", data_eztar_750_set2_bkg); 

  data_file_750_set3_bkg->cd();
  data_file_750_set3_bkg->GetObject("H_Em_nuc_sys", data_Em_750_set3);
  data_file_750_set3_bkg->GetObject("H_ez_tar", data_eztar_750_set3_bkg); 
  ...
  data_file_750_set1->GetObject("H_ez_tar", data_eztar_750_set1); 
  data_file_750_set2->cd();
  data_file_750_set2->GetObject("H_ez_tar", data_eztar_750_set2); 
  data_file_750_set3->cd();
  data_file_750_set3->GetObject("H_ez_tar", data_eztar_750_set3); 
  ...
  data_eztar_750_set1->Add(data_eztar_750_set2);
  data_eztar_750_set1->Add(data_eztar_750_set3);
  data_eztar_750_set1->Draw("E0");
  ...
  data_eztar_750_set1_bkg->Add(data_eztar_750_set2_bkg);
  data_eztar_750_set1_bkg->Add(data_eztar_750_set3_bkg);
  data_eztar_750_set1_bkg->SetLineColor(kRed);
  data_eztar_750_set1_bkg->Draw("samesE0");
  ...
  */
  Double_t I_750_data_eztar = 0.0;
  Double_t err_750_data_eztar = 0.0;

  Double_t I_750_bkg_eztar = 0.0;
  Double_t err_750_bkg_eztar = 0.0;
  ...
  */
  ...
  I_750_data_eztar = data_eztar_750_set1->IntegralAndError(data_eztar_750_set1->FindBin(-7), data_eztar_750_set1->FindBin(7), err_750_data_eztar );
  I_750_bkg_eztar = data_eztar_750_set1_bkg->IntegralAndError(data_eztar_750_set1_bkg->FindBin(-7), data_eztar_750_set1_bkg->FindBin(7), err_750_bkg_eztar );
  
  cout << "data+bkg eztar yield = " <<  I_750_data_eztar << " +/- " << err_750_data_eztar << endl;
  cout << "bkg eztar yield = " <<  I_750_bkg_eztar << " +/- " << err_750_bkg_eztar << endl;
  cout << "bkg / (data+bkg) = " <<  (I_750_bkg_eztar / I_750_data_eztar) * 100. << " % " << endl;
}
