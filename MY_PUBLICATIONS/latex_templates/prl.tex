...
\documentclass[aps,prl,twocolumn,reprint,showpacs,superscriptaddress,groupedaddress]{revtex4-1}  % for review and submission
...
\leftline{Primary authors: Carlos Yero}
...
Citation 1 \cite{manual} \\
Citation 2 \cite{techreport}
