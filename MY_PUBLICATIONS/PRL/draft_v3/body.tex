...
%:::::Rather than saying sensitivity to different NN potentials, say explicitly: "Up to 300 MeV/c, all models use a similar long-range part of the NN potential. Above 300 MeV/c, corresponding to the medium and short
% range parts of the NN potential, The Paris/AV18 PWIA agree, whereas the CD-Bonn PWIA is different, which indicates the NN potentials in the medium to short range parts greatly differe between the CD-Bonn and Paris/AV18.
%no model describes the data over the entire range--the data has a different shape than any of the models."
...
the PWIA and are within good agreement up $p_{r}\sim750$ MeV/c, whereas the CD-Bonn calculation exhibits a different behaviour which indicates a larger sensitivity on the momentum distribution to the different NN-potentials
at higher missing momenta. At recoil angle $\theta_{nq}=75^{o}$ [Fig. \hyperref[fig:fig1]{1(c)}], FSIs become dominant at $p_{r}>300$MeV/c and exhibit a similar behaviour among all models which obscures any possibility
of extracting the momentum distributions at these angles. \\

% Make a transition between plot 1 and plot 2 to indicate the reason why we take the ratio: Since the shape of the data does not fully agree with any of the models >300 MeV/c, a ratio is taken to
% make sense out of the discrepancy obsevred, and try to understand why are the shapes different. More information can be obtained from a ratio plot, by comparing different calculations relative to the CD-Bonn.
...
\label{fig:fig2}
\end{figure} \\
\indent For $\theta_{nq}=35^{o}$ and $45^{o}$ [Fig. \hyperref[fig:fig2]{2(a)-(b)}] the data is best described by the CD-Bonn PWIA calculation for recoil momenta up to $p_{r}\sim700$ MeV/c and $\sim580$ MeV/c, respectively.
