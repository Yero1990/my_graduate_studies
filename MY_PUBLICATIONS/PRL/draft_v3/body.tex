...
\label{fig:fig2}
\end{figure} \\
\indent For $\theta_{nq}=35^{o}$ and $45^{o}$ [Figs. \hyperref[fig:fig2]{2(a),(b)}] the data is best described by the CD-Bonn PWIA calculation for recoil momenta up to $p_{r}\sim700$ MeV/c and $\sim580$ MeV/c, respectively.
