...
\leftline{Comment to {\tt cyero002@fiu.edu, \tt boeglinw@fiu.edu, \tt jones@jlab.org} by April 10, 2020}
...
transfer $\vec q$. At $\theta_{nq} = 35^\circ$ and $45^\circ$, final state interactions (FSI),
...
missing momenta $p_{r}>700$ MeV/c has been observed. 
\end{abstract}
