...
to $Q^{2}=4.5\pm0.5$ (GeV/c)$^{2}$ and neutron recoil momenta up to $p_{r}\sim 1$ GeV/c which is almost double of the maximum recoil momentum measured in Hall A \cite{PhysRevLett.107.262501}. At the selected kinematic settings with neutron recoil angles between $35^{\circ}$ and $45^{\circ}$, MEC and IC are
