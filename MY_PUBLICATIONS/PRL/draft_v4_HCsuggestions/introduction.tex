...
the bound proton which is subsequently ejected from the nucleus without further interaction with the recoiling system (neutron). The neutron carries a recoil momentum, $p_{r}$, equal in magnitude but opposite in direction
...
electro-disintegration reaction at $p_{r}>300$ MeV/c.\\
