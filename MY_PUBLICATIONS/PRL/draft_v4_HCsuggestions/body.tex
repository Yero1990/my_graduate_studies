...
and added in quadrature for overlapping $p_{r}$ bins. For $\theta_{nq}= 35^{\circ}, 45^{\circ}$ and $75^{\circ}$ (presented in this Letter) the overall kinematic uncertainty varied up to 6.5$\%$ for $p_{\mathrm{r}}\lesssim 1$ GeV/c.
