...
\indent The recoiling neutron was reconstructed using energy-momentum conservation. The recoil momentum is defined as $\vec{p_{\mathrm{r}}} = \vec{q} - \vec{p_{\mathrm{f}}}$
...
\indent The experimental and theoretical reduced cross 
\onecolumngrid
\begin{center}
\begin{figure}[ht!]
...
\end{center}
\twocolumngrid
\noindent sections were extracted and are defined as follows:
\begin{equation}
...
is a recoil factor obtained by integrating over the deuteron binding energy in the 6-fold differential cross section, and $\sigma_{\mathrm{cc1}}$ is the
