...
for i, ithnq in enumerate(thnq_arr):
    ...
    B.pl.legend(ncol=2, loc='upper right', prop={'size': 15}) 

    B.pl.ylim(0.0, 5.)
    B.pl.title(r'Radiative Correction Factor, $\theta_{\mathrm{nq}}=%i \pm 5^{\circ}$'%(ithnq))                          #Set common title
    B.pl.xlabel(r'Recoil Momenta, P$_{\mathrm{r}}$ (GeV/c)')                           #Set common x-label
    B.pl.ylabel(r'f$_{\mathrm{rad}}$=$\sigma_{\mathrm{norad}}/\sigma_{\mathrm{rad}}$')  #Set common y-label
    B.pl.tight_layout()
    #B.pl.show()
    ...
    B.pl.ylim(0.5, 1.5)
    B.pl.title(r'Bin Centering Correction Factor, $\theta_{\mathrm{nq}}=%i \pm 5^{\circ}$'%(ithnq))                          #Set common title
    B.pl.xlabel(r'Recoil Momenta, P$_{\mathrm{r}}$ (GeV/c)')                           #Set common x-label
    B.pl.ylabel(r'f$_{\mathrm{bc}}$=$\sigma^{\mathrm{model}}/\bar{\sigma}^{\mathrm{model}}}$')  #Set common y-label
    B.pl.tight_layout()
    #B.pl.show()
