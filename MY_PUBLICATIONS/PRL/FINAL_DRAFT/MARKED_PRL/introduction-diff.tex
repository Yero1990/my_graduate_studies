...
\indent In addition to \DIFaddbegin \DIFadd{the }\DIFaddend PWIA picture, the ejected nucleon undergoes final state interactions (FSI) with the recoiling nucleon. Other contributing processes are
...
\indent In the Hall A experiment \cite{PhysRevLett.107.262501}, the pair of high resolution spectrometers (HRS) made it possible to measure the missing momentum dependence of the cross \DIFdelbegin \DIFdel{sections }\DIFdelend \DIFaddbegin \DIFadd{section }\DIFaddend for fixed neutron recoil angles ($\theta_{nq}$)
