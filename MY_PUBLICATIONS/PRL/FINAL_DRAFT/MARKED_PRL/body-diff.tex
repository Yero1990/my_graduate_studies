...
to the statistical uncertainty (20-30$\%$ on average) to obtain the final uncertainty in the cross section. \\
...
\end{center}
\twocolumngrid
\noindent were found. The experimental and theoretical reduced cross sections were extracted and are defined as follows:
\begin{equation}
