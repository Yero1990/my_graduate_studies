...
=======
%DIF DEL supp_revised_v3.tex   Tue Oct 20 00:28:50 2020
%DIF ADD supp_revised_v4.tex   Tue Oct 20 00:30:31 2020
...
\begin{figure}[!h]
<<<<<<< HEAD
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.33]{plots/Em_and_Q2_CUT_80MeV_35deg.png}
%DIFDELCMD < %%%
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.33]{plots/deltaAcc_and_ZtarCUT_80MeV_35deg.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.24]{plots/deltaAcc_and_ZtarCUT_80MeV_35deg.png}
=======
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.24]{plots/Em_and_Q2_CUT_80MeV_35deg.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.33]{plots/Em_and_Q2_CUT_80MeV_35deg.png}
\DIFaddendFL \caption{Event selection cuts on missing energy (left) and 4-momentum transfer (right).}
\label{fig:Em_Q2_cuts}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.24]{plots/deltaAcc_and_ZtarCUT_80MeV_35deg.png}
%DIFDELCMD < %%%
...
\begin{figure}[!h]
<<<<<<< HEAD
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.33]{plots/coin_and_eCal_CUT_80MeV_35deg.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.23]{plots/coin_and_eCal_CUT_80MeV_35deg.png}
...
=======
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.22]{plots/coin_and_eCal_CUT_80MeV_35deg.png}
%DIFDELCMD < %%%
...
\begin{figure}[!h]
<<<<<<< HEAD
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.25]{plots/collimator_CUT_80MeV_35deg_data.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.24]{plots/collimator_CUT_80MeV_35deg_data.png}
...
=======
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.22]{plots/collimator_CUT_80MeV_35deg_data.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.25]{plots/collimator_CUT_80MeV_35deg_data.png}
\DIFaddendFL \caption{(left) Geometrical acceptance cut on reconstructed events projected at the HMS collimator. (right) The SHMS events (correlated with HMS events on left plot),
  projected at the SHMS collimator. \DIFaddbeginFL \DIFaddFL{The $z$-axis (color palette) is in arbitrary units.}\DIFaddendFL }
>>>>>>> 19c4a9ccdd64f67306c82a65bb33aceb646283a5
...
\begin{figure}[!h]
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.25]{plots/collimator_CUT_80MeV_35deg_SIMC.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.24]{plots/collimator_CUT_80MeV_35deg_SIMC.png}
...
=======
HMS can punch through the collimator with a probability that is related to the \DIFdelbegin \DIFdel{proton-Aluminum }\DIFdelend \DIFaddbegin \DIFadd{proton-Tungsten }\DIFaddend total cross section. Figure \ref{fig:data_coll_cuts} (right)
shows the correlated events projected at the SHMS collimator which clearly shows that the events are well within the collimator which indicates that the SHMS
acceptance is driven by that of the HMS. Figure \ref{fig:simc_coll_cuts} shows the same acceptance cuts as previously described, but for simulation. \DIFaddbegin \DIFadd{The colored
$z$-axis in both figures is given in arbitrary units.}\DIFaddend \\
\begin{figure}[!h]
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.24]{plots/collimator_CUT_80MeV_35deg_SIMC.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.25]{plots/collimator_CUT_80MeV_35deg_SIMC.png}
\DIFaddendFL \caption{Same as Fig. \ref{fig:data_coll_cuts}, but for simulation.  \DIFaddbeginFL \DIFaddFL{The $z$-axis (color palette) is in arbitrary units.}\DIFaddendFL }
>>>>>>> 19c4a9ccdd64f67306c82a65bb33aceb646283a5
...
=======
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.18]{plots/d2_kin_thnq35.png}
%DIFDELCMD < %%%
...
\end{figure}
\begin{figure}[!h]
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.18]{plots/d2_kin_thnq45.png}
%DIFDELCMD < %%%
...
\caption{(left) Missing energy spectrum for the deuteron 580 MeV/c setting with event selection region corresponding to Aluminum endcaps (in red) and deuteron missing energy peak over
  ...
  scale.}\DIFaddendFL }
=======
range. The integral over endcaps and $^{2}\mathrm{H}(e,e'p)n$ events show that the contribution from the cell walls \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{has an upper limit of }\DIFaddend 0.00806/0.275 $\sim$ 0.0293 or approximately 2.9 $\%$
\DIFdelbegin \DIFdel{which is negligible. }\DIFdelend \DIFaddbegin \DIFadd{as the integral was done over all recoil angles, $\theta_{nq}$. This result was added quadratically to the overall normalization error.
}\DIFaddend \begin{figure}[!h]
\includegraphics[scale=0.33]{plots/tgt_bkg_d2_pm580_allthnq.png}
\caption{(left) Missing energy spectrum for the deuteron 580 MeV/c setting with event selection region corresponding to Aluminum endcaps (in red) and deuteron missing energy peak over
  a 40 MeV range, each.  \DIFaddbeginFL \DIFaddFL{Inset }\DIFaddendFL (\DIFaddbeginFL \DIFaddFL{left): Missing energy spectrum on a logarithmic scale. (}\DIFaddendFL right) The SHMS $z$-reaction vertex corresponding to
  the specified region in the missing energy spectrum.\DIFdelbeginFL \DIFdelFL{Inset (left): Missing energy spectrum on a logarithmic
  scale.}\DIFdelendFL }
>>>>>>> 19c4a9ccdd64f67306c82a65bb33aceb646283a5
\label{fig:tgt_wall}
\end{figure}
...
\begin{figure}[!h]
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.26]{plots/RC_factor.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.27]{plots/RC_factor.png}
...
%DIFDELCMD < \includegraphics[scale=0.26]{plots/BC_factor.png}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIF > \indent A study of the sensitivity on the experimental cross section due to variations in the event selection cuts was carried out. 
%DIF > To determine if the variation in each of the cuts contributes to a systematic effect and whether this contribution is significant
%DIF > enough to be considered as a systematic error, we used the approach by R. Barlow described in Ref. \cite{barlow2002systematic}.\\
%DIF > \indent Consider a cross section measurement done two different ways (i.e., apply different cuts). Let the measurements and their
%DIF > statistical uncertainties be: ($\sigma^{\mathrm{exp}}_{\mathrm{1}}\pm\delta\sigma^{\mathrm{exp}}_{\mathrm{1}}$) and ($\sigma^{\mathrm{exp}}_{\mathrm{2}}\pm\delta\sigma^{\mathrm{exp}}_{\mathrm{2}}$)
%DIF > where one of the measurements is a subset of the other. The difference and its associated uncertainty can be expressed as,
%DIF > \begin{subequations}
%DIF >   \begin{align}
%DIF >     &\Delta \equiv \sigma^{\mathrm{exp}}_{\mathrm{1}} - \sigma^{\mathrm{exp}}_{\mathrm{2}}, \\
%DIF >     &\sigma^{2}_{\Delta} \equiv (\delta\sigma^{\mathrm{exp}}_{\mathrm{1}})^{2} - (\delta\sigma^{\mathrm{exp}}_{\mathrm{2}})^{2},
%DIF >   \end{align}
%DIF > \end{subequations}
%DIF > where the error of the difference between the two measurements is found by taking the difference of their variance. As demonstrated in Ref.\cite{barlow2002systematic}, this
%DIF > error accounts for the possible correlation between the two measurements. By taking the ratio
%DIF > \begin{equation}
%DIF >   R_{\mathrm{Barlow}} \equiv \frac{\Delta}{\sigma_{\Delta}},
%DIF > \end{equation}
%DIF > a criterion imposed on $R_{\mathrm{Barlow}}$ determines whether the difference is significant enough to be considered as a systematic error or sufficiently small that it may be
%DIF > ignored. This criterion requires knowledge of the correlation between the subsets, but in general, as suggested in Ref.\cite{barlow2017}: if $R_{\mathrm{Barlow}} < 2$ (or $\Delta <2\sigma_{\Delta}$)
%DIF > the test passes and if $R_{\mathrm{Barlow}} > 4$ (or $\Delta >4\sigma_{\Delta}$), the test fails and the discrepancy must be added as a systematic error. For $2<R_{\mathrm{Barlow}}<4$, a judgement must be made.\\
%DIF > \indent Figure \ref{fig:Em_sys} below shows an example of the systematic effects on the missing energy cut for $\theta_{nq}=35^{\circ}$ and $45^{\circ}$ over the full $p_{\mathrm{r}}$ range.
%DIF > In Fig. \ref{fig:Em_sys}, the different color groups represent the Barlow ratio evaluated at difference between the subset and full missing energy cut range. For mostly the entire momentum range,
%DIF > the Barlow ratio was kept within 2-4 standard deviations with the exception of a few outliers which can be understood from the fact that these might have very similar variances. These systematic
%DIF > studies were mainly done to check the stability of the event selection cuts and the effects of cut variation on the cross section were found to be negligible. Similar plots for the other event selection
%DIF > cuts systematics can be found in Section 5.10 of Ref. \cite{cyero_phdthesis}. 
%DIF > \clearpage
%DIF > \begin{figure}[!ht]
%DIF > \includegraphics[scale=0.4]{plots/Em_syst.png}
%DIF > \caption{Systematic effects of the missing energy cut on the data cross section for $\theta_{nq}=35^{\circ}$ (left) and $45^{\circ}$ (right). The inner (black dashed) and outer (black solid)
%DIF >   lines represent the $\Delta=\pm2\sigma_{\Delta}$ and $\pm4\sigma_{\Delta}$ boundaries, respectively.}
%DIF > \label{fig:Em_sys}
%DIF > \end{figure}
...
To determine if the variation in each of the cuts contributes to a systematic effect and whether this contribution is significant
enough to be considered as a systematic error, we used the approach by R. Barlow described in Ref. \mbox{%DIFAUXCMD
\cite{barlow2002systematic}}\hspace{0pt}%DIFAUXCMD
.}%DIFDELCMD < \\
%DIFDELCMD < \indent %%%
...
%DIFDELCMD < %%%
\DIFdel{where the error of the difference between the two measurements is found by taking the difference of their variance. As demonstrated in Ref.\mbox{%DIFAUXCMD
\cite{barlow2002systematic}}\hspace{0pt}%DIFAUXCMD
, this
error accounts for the possible correlation between the two measurements. By taking the ratio
}\begin{displaymath}
...
ignored. This criterion requires knowledge of the correlation between the subsets, but in general, as suggested in Ref.\mbox{%DIFAUXCMD
\cite{barlow2017}}\hspace{0pt}%DIFAUXCMD
: if $R_{\mathrm{Barlow}} < 2$ (or $\Delta <2\sigma_{\Delta}$)
the test passes and if $R_{\mathrm{Barlow}} > 4$ (or $\Delta >4\sigma_{\Delta}$), the test fails and the discrepancy must be added as a systematic error. For $2<R_{\mathrm{Barlow}}<4$, a judgement must be made.}%DIFDELCMD < \\
%DIFDELCMD < \indent %%%
...
the Barlow ratio was kept within 2-4 standard deviations with the exception of a few outliers which can be understood from the fact that these might have very similar variances. These systematic
studies were mainly done to check the stability of the event selection cuts and the effects of cut variation on the cross section were found to be negligible. Similar plots for the other event selection
cuts systematics can be found in Section 5.10 of Ref. \mbox{%DIFAUXCMD
\cite{cyero_phdthesis}}\hspace{0pt}%DIFAUXCMD
. 
}%DIFDELCMD < \clearpage
%DIFDELCMD < \begin{figure}[!ht]
%DIFDELCMD < \includegraphics[scale=0.4]{plots/Em_syst.png}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Systematic effects of the missing energy cut on the data cross section for $\theta_{nq}=35^{\circ}$ (left) and $45^{\circ}$ (right). The inner (black dashed) and outer (black solid)
  lines represent the $\Delta=\pm2\sigma_{\Delta}$ and $\pm4\sigma_{\Delta}$ boundaries, respectively.}}
%DIFAUXCMD
%DIFDELCMD < \label{fig:Em_sys}
%DIFDELCMD < \end{figure}
%DIFDELCMD < \indent %%%
\DIFdel{The systematic }\DIFdelend \DIFaddbegin \DIFadd{The systematic }\DIFaddend effect on the cross sections due to model dependency of the radiative and bin-centering corrections was investigated \DIFaddbegin \DIFadd{(see Section 5.10 of Ref. \mbox{%DIFAUXCMD
\cite{cyero_phdthesis}}\hspace{0pt}%DIFAUXCMD
)
}\DIFaddend using the Barlow ratio approach \DIFdelbegin \DIFdel{described above}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{barlow2002systematic,barlow2017}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . In this case, the ratio was calculated from the difference between the experimental cross
>>>>>>> 19c4a9ccdd64f67306c82a65bb33aceb646283a5
...
\bibliography{supp}
=======
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.31]{plots/rad_sys.png}
%DIFDELCMD < %%%
...
\DIFaddendFL \caption{Systematic effects of the radiative corrections model dependency on the data cross sections
  ...
  lines represent the $\Delta=\pm2\sigma_{\Delta}$ and $\pm4\sigma_{\Delta}$ boundaries, respectively.  }
\label{fig:rad_sys}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.31]{plots/bc_sys.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \end{figure}
\begin{figure}[!ht]
\includegraphics[scale=0.37]{plots/bc_sys.png}
\DIFaddendFL \caption{Same as Fig. \ref{fig:rad_sys} but for bin-centering correction systematics.}
\label{fig:bc_sys}
\end{figure}\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
%DIF < \clearpage
\DIFdelend \DIFaddbegin \\
\indent \DIFadd{Systematic studies of the event selection cuts described above were also carried out using the R. Barlow approach. The studies demonstrated that variations in the software had a negligible
effect in the measured cross sections and thus no systematic uncertainties due to software cuts were included in the final result. For a detailed discussion of these studies see Section 5.10 of Ref. \mbox{%DIFAUXCMD
\cite{cyero_phdthesis}}\hspace{0pt}%DIFAUXCMD
.
}\\\\
\DIFaddend \bibliography{supp}
>>>>>>> 19c4a9ccdd64f67306c82a65bb33aceb646283a5
