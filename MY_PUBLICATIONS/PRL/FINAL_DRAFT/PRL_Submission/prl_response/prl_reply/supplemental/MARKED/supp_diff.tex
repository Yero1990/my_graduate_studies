...
%DIF DEL supp.tex           Wed Oct 14 19:57:08 2020
%DIF ADD supp_revised.tex   Wed Oct 14 19:58:45 2020
...
energy cut around the deuteron binding energy ($\sim$2.2 MeV) using the missing energy formula\DIFdelbegin \DIFdel{described in the Letter, where the
recoiling system is assumed to be a }\DIFdelend \DIFaddbegin \DIFadd{, $E_{\mathrm{m}} = \omega - T_{p} - T_{\mathrm{r}}$, where
...
4-momentum vectors assuming an exclusive three-body final state with a recoiling }\DIFaddend neutron. The peak is not exactly at the deuteron binding energy because
energy loss corrections have not been applied to the data nor SIMC. \DIFaddbegin \\
