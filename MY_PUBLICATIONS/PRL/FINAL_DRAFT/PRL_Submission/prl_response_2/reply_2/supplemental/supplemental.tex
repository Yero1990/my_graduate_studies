...
\begin{figure}[!h]
\includegraphics[scale=0.3]{Pr_and_Ps_35deg.png}
\includegraphics[scale=0.3]{Pr_and_Ps_45deg.png}
...
\label{fig:Pm_Ps}
\includegraphics[scale=0.3]{RedXsec_overlap.png}
\caption{Reduced cross section overlap region between the 580 and 750 MeV/c settings.}
