...
At larger recoil momenta where the ratio is $R>1$ and increasing.  At $\theta_{nq}=35^{o}$ FSI start to dominate for missing moment above typically above 800 MeV/c for the CD-Bonn calculation
