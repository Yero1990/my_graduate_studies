...
in the regions in which there is an overlap in $p_{r}$. \\
\indent Below $p_{r}\sim 300$ MeV/c, both Hall A and C data agree well with all theoretical models, as FSIs and other non-cucleonic 
\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
\onecolumngrid
