...
\indent \DIFaddbegin \DIFadd{Moreover, in spite of the partial agreement between data and theory, between $p_{\mathrm{r}} \sim 0.55$ and 1.0 GeV/c, all models exhibit a
...
4.241 standard deviations was found between the data and theory slopes which corresponds to a probability $\leq 1.1\times 10^{-5}$ (very unlikely) that the observed discrepancy is due to a statistical fluctuation. }\\ 
