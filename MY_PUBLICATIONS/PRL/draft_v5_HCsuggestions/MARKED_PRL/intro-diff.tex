...
\indent At large $Q^{2}$, FSI \DIFdelbegin \DIFdel{are }\DIFdelend \DIFaddbegin \DIFadd{can be }\DIFaddend described by the \DIFdelbegin \DIFdel{General }\DIFdelend \DIFaddbegin \DIFadd{Generalized }\DIFaddend Eikonal Approximation (GEA) \cite{Sargsian_2001,PhysRevC.56.1124,sargsian_2015}, which predicts a strong dependence of FSI on neutron recoil angles $\theta_{nq}$.
