...
%DIF DEL prl_old.tex   Mon May 18 23:30:14 2020
%DIF ADD prl_new.tex   Mon May 18 23:29:41 2020
%%
%%
...
\widetext
\DIFdelbegin %DIFDELCMD < \leftline{Version 04 as of \today}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \leftline{Version 05 as of \today}
\DIFaddend \leftline{Primary authors: Carlos Yero, Werner Boeglin, Mark Jones}
\leftline{To be submitted to PRL}
\leftline{Comment to {\tt cyero002@fiu.edu, \tt boeglinw@fiu.edu, \tt jones@jlab.org} by May 01, 2020}
...
%DIF > \title{Deuteron Electro-Disintegration up to $\sim$ 1 GeV/c Missing Momentum}
\title{\DIFaddbegin \DIFadd{Probing the }\DIFaddend Deuteron \DIFdelbegin \DIFdel{Electro-Disintegration }\DIFdelend at Very \DIFdelbegin \DIFdel{High Missing }\DIFdelend \DIFaddbegin \DIFadd{Large Internal }\DIFaddend Momenta}
\DIFaddbegin 

\DIFaddend \input authorlist.tex
