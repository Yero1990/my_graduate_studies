...
%relative to the deuteron momentum distributions (n$(p_{r})$) using the charge-dependent Bonn (CD-Bonn)\cite{PhysRevC.63.024001} potential is shown in Fig. \ref{fig:fig2}. The theoretical calculations for the
...
%in good agreement with all models for the neutron recoil angles shown in Fig. \ref{fig:fig2}. For $p_{r}\gtrsim 300$, at recoil angles $\theta_{nq} = 35^{o}\pm5^{o}$ [Fig. \hyperref[fig:fig2]{2(a)}],
...
%with a maximal ratio of R$\sim$3 at $p_{r}\sim$940 MeV/c due to statistical limitations. For recoil angles $\theta_{nq} = 45^{o}\pm5^{o}$ [Fig. \hyperref[fig:fig2]{2(b)}], both the data and
...
%a similar behaviour as in Fig. \hyperref[fig:fig2]{2(a)} with an early rise in the ratio than predicted by the CD-Bonn FSI model. For $\theta_{nq} = 75^{o}\pm5^{o}$ [Fig. \hyperref[fig:fig2]{2(c)}], the
