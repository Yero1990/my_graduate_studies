...
\begin{figure}[H]
  ...
  \end{figure}
\newpage
The plot in Figure \ref{fig:TWFit} shows the correlation between TDC Pulse Time and ADC Pulse Amplitude.
...
The cable time offset parameter is determined for all paddles and the parameter is read by \texttt{hcana}, and added as a correction
